...
public class UserController {
    ...
    @Operation(summary = "分页查询用户",
            ...
            responses = {
                    @ApiResponse(content = @Content(mediaType = "application/json", schema = @Schema(implementation = PageResult.class))),
            })
    ...
    @Operation(summary = "通过ID查询用户",
            ...
            responses = {
                    @ApiResponse(content = @Content(mediaType = "application/json", schema = @Schema(implementation = SysUserDto.class))),
            })
